...
export default function Navbar() {
    ...
    return (
        <nav className="flex flex-wrap justify-center items-center   md:px-10  py-4  ">
            <div className="bg-white shadow flex flex-wrap justify-center items-center rounded-b-xl px-2 py-2 space-x-10">
